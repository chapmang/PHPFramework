...
return array (
	...
	*/
	...
	"key" => "LQ6eS614cQxWXdCiCvVg6pnl32R5y4YL",
	...
	| to know what type of encoding to use.
	|
	*/
	...
	| the framework needs a date, such as when writing to a log file.
	|
	*/
	...
	|--------------------------------------------------------------------------
	|
	| To add security to the registration process there is the option to send
	| a confirmation email to the address used in registration.
	|
	*/
